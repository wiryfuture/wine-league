...
RUN ./wine-staging/patches/patchinstall.sh DESTDIR=/builddir/wine --all -W loader-KeyboardLayouts -W secur32-InitializeSecurityContextW -W winex11-CandidateWindowPos
