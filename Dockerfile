...
RUN ./wine-staging/patches/patchinstall.sh DESTDIR=/builddir/wine --all -W /builddir/wine-staging/patches/loader-KeyboardLayouts/0002-user32-Improve-GetKeyboardLayoutList.patch
