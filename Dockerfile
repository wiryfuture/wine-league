...
RUN ./wine-staging/patches/patchinstall.sh DESTDIR=/builddir/wine --all --backend=git-am -W /builddir/wine-staging/patches/loader-KeyboardLayouts/0002-user32-Improve-GetKeyboardLayoutList.patch
...
RUN cd /builddir/wine && git am /builddir/patches/0005-try-decrease-number-of-unecessary-resets.patch
